...
links <- paste0("https://www.reed.co.uk/jobs/data-analyst-jobs-in-london?pageno=",seq(1:40)) %>% as.data.frame(stringsAsFactors=FALSE)
#links
...
## export file
write_excel_csv(job_listings,"data analyst job listing.csv")
